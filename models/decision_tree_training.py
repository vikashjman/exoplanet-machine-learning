...
def train_and_evaluate_decision_tree(train_df, test_df):
    ...
    model = DecisionTreeClassifier(random_state=42)  # Ensuring reproducibility
    ...
    report_path = os.path.join(reports_dir, 'DecisionTree_report.json')
...
if __name__ == '__main__':
    ...
    train_and_evaluate_decision_tree(train_df, test_df)
