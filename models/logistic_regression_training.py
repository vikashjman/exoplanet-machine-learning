...
def train_and_evaluate_logistic_regression(train_df, test_df):
    ...
    report_path = os.path.join(reports_dir, 'LogisticRegression_report.json')
...
if __name__ == '__main__':
    ...
    train_and_evaluate_logistic_regression(train_df, test_df)
