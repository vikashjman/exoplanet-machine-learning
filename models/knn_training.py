...
def train_and_evaluate_knn(train_df, test_df):
    ...
    model = KNeighborsClassifier(n_neighbors=5)  # Using default 5 neighbors
    ...
    report_path = os.path.join(reports_dir, 'KNN_report.json')
...
if __name__ == '__main__':
    ...
    train_and_evaluate_knn(train_df, test_df)
